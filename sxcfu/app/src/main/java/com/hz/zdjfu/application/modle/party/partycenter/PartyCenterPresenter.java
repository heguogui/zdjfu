...
public class PartyCenterPresenter implements PartyCenterContract.Presenter{


    private PartyCenterContract.View mView;
    private int currPage =0;
    private Context mContext;

    public PartyCenterPresenter(PartyCenterContract.View view,Context context){
        this.mView =view;
