...
public class LockPatternUtils {
	...
	private static LockPatternUtils mInstance;
	 ...
	 * @return
	 */
	public static synchronized LockPatternUtils createInstance(Context context) {
		if (mInstance == null) {
			mInstance = new LockPatternUtils(context);
		}
		return mInstance;
	}
	 ...
	 * @return
	 */
	public static synchronized LockPatternUtils getInstance() {
		if (mInstance == null)
