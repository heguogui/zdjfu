 ...
 * 自定义刷新页底部信息
 */
public class CustomRefreshFooterView extends LinearLayout implements IFooterCallBack {

    private View mProgressBar,mContentView;
...
//        setVisibility(show?VISIBLE:GONE);
    ...
    private void initView(Context context) {
        ...
        ViewGroup moreView = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.refresh_footer_layout, this);
        moreView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        mContentView = moreView.findViewById(R.id.xrefreshview_footer_content);
        mProgressBar = moreView.findViewById(R.id.xrefreshview_footer_progressbar_view);
        mHintView = (TextView) moreView.findViewById(R.id.xrefreshview_footer_hint_textview_view);
        mClickView = (TextView) moreView.findViewById(R.id.xrefreshview_footer_click_textview_view);
    }
