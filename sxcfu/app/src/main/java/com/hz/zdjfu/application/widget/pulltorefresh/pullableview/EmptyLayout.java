...
public class EmptyLayout {
	...
	public EmptyLayout(Context context) {
		...
		this.mEmptyMessage = context.getResources().getString(R.string.empty_message);
		this.mLoadingMessage = context.getResources().getString(R.string.loading);
		this.mErrorMessage = context.getResources().getString(R.string.http_timeout);
	}
