...
public class InvestRewordLists {
    ...
    private List<InvestRewordBean> dataList;
    ...
    public List<InvestRewordBean> getDataList() {
        return dataList;
    }

    public void setDataList(List<InvestRewordBean> dataList) {
        this.dataList = dataList;
    }

    @Override
    public String toString() {
        return "InvestRewordLists{" +
                "total='" + total + '\'' +
                ", start='" + start + '\'' +
                ", limit='" + limit + '\'' +
